...
rsu_scenario = [4]
cpu_scenario = [2]
lmda_zones = [[0.4, 0.3, 0.2, 0.5], ] # [[1.24, 1.13, 0.32, 0.55], ]  # [[1.4, 0.8, 0.9, 2.1], ]
epsilon_greedy = 0.2
is_ucb = True
        ...
        for is_ucb in [True]:
            ...
            for n_rsu in rsu_scenario:
                for cpu in cpu_scenario:
                    ...
                    agents = [EpsGreedy(8, epsilon_greedy) for _ in range(n_rsu)] if not is_ucb else [UCB(8, 2, type="mixed") for _ in range(n_rsu)]
